...
export default function Footer() {
  return (
    <>
      <footer className="relative z-10  bg-gray-800 mt-4 pb-10 pt-8 dark:bg-dark lg:pb-16 lg:pt-12">
              ...
              <div className="mb-10 w-full">
                <a href="#" className="mb-6 inline-block ">
                  <div className="flex items-center justify-center">
                    ...
                    />
                    <p className=" ml-2 font-semibold text-[rgb(105,240,255)] text-base">
                      Delivery Partner Service
                    </p>
                  </div>
                </a>
                <p className="mb-7 text-base text-body-color dark:text-white">
                  For all your queries you can reach us at
                 <span className="text-[rgb(105,240,255)]"> partnerservices@flipkart.com</span> 
                </p>
