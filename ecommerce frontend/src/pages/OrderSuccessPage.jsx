...
export function OrderSuccessPage() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center bg-slate-900 h-[100lvh] w-[100vw]">
        <div className="text-center w-[90%]  md:w-[70vw] lg:w-[50vw] flex flex-col mt-20 items-center justify-center bg-gray-200 p-8 md:px-16 md:py-20 ">
