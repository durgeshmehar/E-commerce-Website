        ...
        <section aria-labelledby="products-heading" className="pb-24 pt-6">
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            ...
            <div className="lg:col-span-3">
              {/* Your content */}
              <div>
                <div className="flex flex-wrap gap-10 gap-y-16 justify-around">
                  {products &&
                    products.map((product) => (
                      <div
                        className=" text-md  border border-solid border-spacing-2  border-gray-300 rounded-md w-8/12 md:w-6/12 lg:w-[30%]"
                        key={product.id}
                      >
                        <Link to="/product-detail">
                          {/* <div className="rounded-md bg-violet-600 mb-4 pb-2"> */}
                          <div className="overflow-hidden rounded-md">
                            <img
                              src={product.thumbnail}
                              className="w-full h-60 hover:opacity-70 transition-opacity duration-100 cursor-pointer "
                              alt="cloth-image"
                            />
                          </div>
                          {/* </div> */}
                          ...
                          <div className="p-4">
                            <div className="flex justify-between font-medium">
                              ...
                              <div> ${Math.round( product.price- (product.discountPercentage*product.price/100))} </div>
                            </div>
                            <div className="flex justify-between font-medium py-[2px]">
                              ...
                              <div className="opacity-60 font-normal line-through"> {product.price}</div>
                            </div>
                          </div>
                        </Link>
                      </div>
