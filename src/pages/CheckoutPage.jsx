...
const addresses = [
  ...
  },
  {
    ...
    city: "Mumbai",
    state: "Maharashtra",
    street: "21th Shanti Niketan",
    pincode: "423462",
    mobile: "+91-7872343219",
  },
];
    ...
    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-5">
        <div className="md:col-span-3">
          <form className="bg-white px-10 mt-12">
        ...
        <div className="md:col-span-2">
          <div className="bg-white mx-auto max-w-7xl mt-12 sm:px-2 lg:px-4 ">
            <h1 id="products-heading" className="p-4 text-2xl font-bold">
              Cart
            </h1>
